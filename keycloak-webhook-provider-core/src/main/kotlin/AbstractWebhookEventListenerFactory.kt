...
abstract class AbstractWebhookEventListenerFactory(
    private val delegateFactory: () -> WebhookHandler
    ...
    override fun create(session: KeycloakSession): EventListenerProvider = WebhookEventListenerProvider(session, delegateFactory())

    override fun close() {}

    private class WebhookEventListenerProvider(
